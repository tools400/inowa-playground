...
abstract class $DeviceInteractionViewModel {
  ...
  Future<int> Function() get requestMtu;
  ...
  DeviceInteractionViewModel copyWith({
    ...
    Future<int> Function()? requestMtu,
    Future<List<Service>> Function()? discoverServices,
      ...
      DeviceInteractionViewModel(
        ...
        requestMtu: requestMtu ?? this.requestMtu,
  ...
  @override
  String toString() =>
      "DeviceInteractionViewModel(deviceId: $deviceId, connectableStatus: $connectableStatus, connectionStatus: $connectionStatus, deviceConnector: $deviceConnector, readRssi: $readRssi, requestMtu: $requestMtu, discoverServices: $discoverServices)";
  ...
  int get hashCode {
    ...
    result = 37 * result + requestMtu.hashCode;
...
class DeviceInteractionViewModel$ {
  ...
  static final requestMtu =
      Lens<DeviceInteractionViewModel, Future<int> Function()>(
    (requestMtuContainer) => requestMtuContainer.requestMtu,
    (requestMtuContainer, requestMtu) =>
        requestMtuContainer.copyWith(requestMtu: requestMtu),
  );
