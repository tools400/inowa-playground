...
/// is generated as 'device_interaction_tab.g.dart'.
@immutable
@FunctionalData()
...
class _DeviceInteractionTabState extends State<_DeviceInteractionTab> {
  ...
  Future<void> readMtu() async {
    final mtu = await widget.viewModel.requestMtu();
    setState(() {
      _mtu = mtu;
    });
  }
                ...
                Padding(
                  ...
                  child: Wrap(
                    ...
                    children: <Widget>[
                      ...
                      ElevatedButton(
                        onPressed:
                            widget.viewModel.deviceConnected ? readMtu : null,
...
class _ServiceDiscoveryListState extends State<_ServiceDiscoveryList> {
  ...
  Widget _characteristicTile(Characteristic characteristic) => ListTile(
        onTap: () => showDialog<void>(
          context: context,
          builder: (context) =>
              // Erzeugt das Popup zur Interaktion
              // mit der Characteristic.
  ...
  List<ExpansionPanel> buildPanels() {
    ...
    widget.discoveredServices.asMap().forEach(
          (index, service) => panels.add(
            // Erezugt ein aufklappbares Panel mit der Liste
            // der Characteristics
            ExpansionPanel(
              body: Column(
